...
# Copy beats (pinned to version 7.2.0) into vendor directory
.PHONY: copy-vendor
copy-vendor:
	mkdir -p vendor/github.com/elastic
	git clone -b 'v7.2.0' --depth 1 https://github.com/elastic/beats.git vendor/github.com/elastic/beats
